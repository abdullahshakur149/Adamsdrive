...
const Testimonials = () => {
  return (
    <div className="bg-white text-center relative mb-12 p-20  mt-0 px-4">
      <Image
        src={opinion}
        className="absolute md:flex -z-10 hidden"
        alt="opinions"
      />
      <h1 className="text-blue-500 font-extrabold font-mona text-sm mb-5">
        Testimonials
      </h1>
