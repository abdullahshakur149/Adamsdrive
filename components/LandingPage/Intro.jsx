...
const IntroSection = () => {
  return (
    <div className=" w-full ">
      ...
      <div className="absolute top-20   left-16 sm:top-24 sm:left-24 md:top-28 md:left-24 lg:top-32 lg:left-36 xl:top-44 xl:left-52 2xl:left-80 2xl:top-60     text-black">
      
        <h1 className=" max-sm:mb-2 text-xl sm:text-xl md:text-xl lg:text-4xl xl:text-5xl 2xl:text-6xl  font-monaBold leading-snug">
        ...
        <div className=" md:mt-3 lg:mt-5 ">
          <div className="feature flex items-center mb-2">
            <FaCheckCircle className="text-blue-600 flex mr-2 text-xs  lg:text-sm" />
            <span className="text-xs   lg:text-xs xl:text-base font-sans font-bold">
          ...
          <div className="feature flex items-center mb-2  lg:mb-5">
            <FaCheckCircle className="text-blue-600 flex mr-2 text-xs  lg:text-sm" />
            <span className="text-xs   lg:text-xs xl:text-base font-sans font-bold">
        ...
        <div className="buttons flex space-x-2 ">
          <button className="p-1 bg-orange-500 text-xs  lg:text-xs xl:text-base xl:px-6 xl:py-3 xl:mt-3 text-white font-bold rounded-lg shadow-lg">
            Courses & Pricing
          </button>
          <button className="p-1  text-xs   lg:text-xs xl:text-base lg:px-6 xl:px-6 lg:py-2 bg-black xl:mt-3 text-white font-bold rounded-lg shadow-lg">
            About Us
          </button>
        </div>
      </div>
      ...
      {/* Stats Section */}
      <div className="container mx-auto bg-default   p-4 sm:p-6 md:p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
        ...
        <div className="stat flex">
          ...
          <div className="info md:mb-16 lg:mb-0">
            ...
            <p className="text-xs  xl:text-base font-bold font-sans">
              Our students drive so many  kilometers every day
            </p>
          </div>
        </div>
      </div>
