...
const CourseandPricing = () => {
    ...
    return (
        <div className="main-container relative w-full h-screen mt-20">
            ...
            <div className='absolute top-0 left-0 right-0 bottom-0 bg-gray-00 bg-opacity-50 flex flex-col justify-center items-center'>
                ...
                <div className="Cards flex md:flex-row flex-col">
                    {card.map((card, index) => {
                        return (
                            <div key={index} className='w-full mt-20 rounded-3xl bg-white h-auto border m-1 shadow-md flex-col p-10'>
                                <div className="price text-blue-600 font-monaBold text-5xl pt-5 text-center mb-10">
                                    {card.Price}
                                </div>
                                <hr />
                                <div className="features mb-10 mt-10 space-y-3">
                                ...
                                <div className="desc2">
                                    <p className='font-mona font-bold text-md text-center'>
                                        {card.Description2}{card.price}
                                    </p>
                                </div>
                                <div className="btn text-center mt-10">
                                    <button className='px-4 py-2 mt-3 font-bold text-white bg-orange-500 rounded-lg'>
                                        {card.Signup}
                                    </button>
                                </div>
                            </div>
