    ...
    return (
        <div className='bg-white flex justify-center relative mt-32 mb-32   w-full'>
            ...
            <div className="data flex justify-center">
                <div className="w-4/12  m-8 flex-col space-y-8 mt-32">
                ...
                <div className="w-4/12 mt-10 m-8 flex relative  flex-col    ">
                <Image src={driving} className='object-contain w-full  absolute -top-24  rounded-3xl'  />
