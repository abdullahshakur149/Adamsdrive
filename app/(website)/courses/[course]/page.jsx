                ...
                <div className="data mt-20   p-10 rounded-xl shadow-md">
                    ...
                    <div className="flex flex-col lg:flex-row gap-10">
                        ...
                        <div className=" p-6 rounded-lg shadow-md  flex-grow">
                            <p className="text-lg text-white mb-6">{courseDetail.courseDescription}</p>

                            <div className="flex flex-col gap-4">
                                <div className="flex items-center ">
                                    <span className="text-white/80 font-semibold mr-2">Category:</span>
                                    <span className="text-neutral-200 text-xl font-bold">{courseDetail.courseCategory}</span>
                                </div>
                                <div className="flex items-center ">
                                    <span className="text-white/80 font-semibold mr-2">Duration:</span>
                                    <span className="text-neutral-200 text-xl font-bold ">{courseDetail.duration} hours</span>
                                </div>

                                {courseDetail.fastTrackIncluded && (
                                    <div className="text-center py-2 bg-green-200 hover:bg-green-100 text-black rounded-lg font-semibold">
                                        Fast Track Included
                                    </div>
                                )}
                        ...
                        <div className="w-full lg:w-1/3 space-y-6">
                            ...
                            <div href={"/Info"} className="flex flex-col  rounded-lg shadow-md text-center">
                                ...
                                <Link href="/Info"
                                    ...
                                    className=" w-full bg-pink-500 text-white p-4 rounded-md font-semibold hover:bg-pink-600"
                                >
                                    BOOK NOW
                                </Link>
                            </div>
